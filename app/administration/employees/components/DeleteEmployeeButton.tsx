// app/administration/employees/components/DeleteEmployeeButton.tsx
"use client";
...
export function DeleteEmployeeButton({ employeeId }: { employeeId: string }) {
  ...
  return (
    <button onClick={handleDelete} className="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-300">
      <TrashIcon />
    </button>
  );
}