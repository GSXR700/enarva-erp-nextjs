...
interface MetricCardProps {
    title: string;
    value: string | number;
    subtitle?: string; // Ajout du prop subtitle comme optionnel
    icon: React.ReactElement<LucideIcon>;
    color: 'blue' | 'green' | 'yellow' | 'purple' | 'indigo' | 'emerald'; // Ajout des couleurs manquantes
    className?: string; // Ajout du prop className comme optionnel
}
